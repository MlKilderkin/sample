...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_cacheTag = 'mn_wall_post';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mn_wall_post';
    ...
    {
        $this->_init('Mn\Wall\Model\ResourceModel\Post');
    }
